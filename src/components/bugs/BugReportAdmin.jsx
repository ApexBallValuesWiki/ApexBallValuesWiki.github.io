...
export default function BugReportAdmin() {
  ...
  async function loadReports() {
    setLoading(true);
    try {
      const response = await fetch(`${SUPABASE_URL}/bug-reports`);
      if (response.ok) {
  ...
  async function markResolved(report) {
    ...
    try {
      const response = await fetch(`${SUPABASE_URL}/bug-reports/resolve`, {
        method: 'POST',
        headers: {
  ...
  async function deleteReport(report) {
    ...
    try {
      const response = await fetch(`${SUPABASE_URL}/bug-reports/delete`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'X-Admin-Email': savedEmail,
