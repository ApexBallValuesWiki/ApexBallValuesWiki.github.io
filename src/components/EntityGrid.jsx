        ...
        return (
          ...
          >
            <div className="entity-card-image-wrap" style={{ height: 130, background: '#12121c', position: 'relative', overflow: 'hidden', borderBottom: '1px solid var(--border, rgba(255,255,255,0.12))', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              {Boolean(e.isPrvw || e.prvw || e.livePrvwOverride) && (
                <span className="badge prvw-badge" style={{ position: 'absolute', top: 10, right: 10, background: '#b679ff', color: '#fff', fontSize: '0.62rem', padding: '2px 8px', fontWeight: 800, borderRadius: '999px', boxShadow: '0 0 10px rgba(182,121,255,0.6)' }}>PRVW</span>
              )}
            </div>
