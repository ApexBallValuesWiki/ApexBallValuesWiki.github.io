          ...
          {item.chances && Object.keys(item.chances).length > 0 && (
            <section className="unit-section" style={{ marginTop: '30px' }}>
              ...
              <div className="crate-drops-grid">
                {Object.entries(item.chances).map(([name, rate]) => {
                  const isUnit = ALL_UNITS.some((u) => u.name.toLowerCase() === name.toLowerCase());
                  const isItem = ALL_ITEMS.some((i) => i.name.toLowerCase() === name.toLowerCase());
                  ...
                  const imgUrl = matchedUnit?.imageUrl || matchedUnit?.image_url || matchedItem?.imageUrl || matchedItem?.image_url || matchedItem?.image || null;
                    ...
                    <>
                      <div className="crate-drop-image">
                        {imgUrl ? (
                          ...
                          <span className="crate-drop-fallback">🎁</span>
                        )}
                      </div>
